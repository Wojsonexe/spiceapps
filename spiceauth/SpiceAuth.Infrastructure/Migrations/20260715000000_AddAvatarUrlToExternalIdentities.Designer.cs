...
namespace SpiceAuth.Infrastructure.Migrations
{
    ...
    [Migration("20260715000000_AddAvatarUrlToExternalIdentities")]
    partial class AddAvatarUrlToExternalIdentities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.OAuth.AppSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("GlobalSessionId")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("LastSeenAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("LocalSessionId")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("GlobalSessionId");

                    b.HasIndex("GlobalSessionId", "AppName")
                        .IsUnique();
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.OAuth.ClientSecret", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("ClientInternalId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClientInternalId", "IsActive");
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.OAuth.FederationDispatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("federation_dispatches", (string)null);
                });

            modelBuilder.Entity("SpiceAuth.Core.Entities.OAuth.FederationDispatchAttempt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("FederationDispatchId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("FederationDispatchId");

                    b.ToTable("federation_dispatch_attempts", (string)null);
                });

            modelBuilder.Entity("SpiceAuth.Core.Entities.OAuth.GlobalSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("global_sessions", (string)null);
                });
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.Organization.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.Organization.TenantMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.Security.LogoutTokenJti", b =>
                {
                    ...
                    b.ToTable("logout_token_jtis", (string)null);
                });
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.Security.ReplayCacheEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("replay_cache_entries", (string)null);
                });
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.Security.SigningKey", b =>
                {
                    ...
                    b.HasIndex("IsActive", "IsPrimary", "ExpiresAt");
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.OAuth.AppSession", b =>
                {
                    b.HasOne("SpiceAuth.Core.Entities.OAuth.GlobalSession", "GlobalSession")
                        .WithMany("AppSessions")
                        .HasForeignKey("GlobalSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GlobalSession");
                });
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.OAuth.ClientSecret", b =>
                {
                    b.HasOne("SpiceAuth.Core.Entities.OAuth.OAuthClient", "Client")
                        .WithMany()
                        .HasForeignKey("ClientInternalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.OAuth.FederationDispatchAttempt", b =>
                {
                    b.HasOne("SpiceAuth.Core.Entities.OAuth.FederationDispatch", "Dispatch")
                        .WithMany("Attempts")
                        .HasForeignKey("FederationDispatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SpiceAuth.Core.Entities.Organization.TenantMembership", b =>
                {
                    b.HasOne("SpiceAuth.Core.Entities.Organization.Tenant", "Tenant")
